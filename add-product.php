...
<body>
  ...
  <div class="button-grid">
    <a href="add-venue.php" class="action-btn"> Add Wedding Destinations</a>
    <a href="add_weding.php" class="action-btn"> Add weding Event</a>
    <a href="add_coporate.php" class="action-btn"> Add Corporate Event</a>
  </div>
</div>
