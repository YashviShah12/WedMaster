...
<html class="no-js" lang="zxx">
    <head>
        ...
        <meta name="description" content="Discover our exquisite collection of premium wedding venues for your dream celebration">
   ...
   <body>
    ...
    <main>
        ...
        <div class="slider-area2">
            <div class="single-slider slider-height2 hero-overly d-flex align-items-center" style="background-image: url('assets/img/hero/venues-hero.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap text-center">
                                <h2 data-aos="fade-up" data-aos-delay="200">Premium Wedding</h2>
        ...
        <section class="venues-section">
            <div class="container">
                <div class="section-title" data-aos="fade-up">
                    <h2>Our Exquisite Wedding</h2>
                    <p>Each venue is carefully selected to provide the perfect backdrop for your wedding celebration</p>
                </div>
                  ...
                  ?>
                    <div class="card" data-aos="fade-up" data-aos-delay="<?= rand(100, 300) ?>">
                        ...
                        <div class="card-body">
                            ...
                            <a href="productview2.php?id=<?= $row['id'] ?>" class="view-btn">View Wedding</a>
                        </div>
                    </div>
                  <?php endwhile; ?>
                </div>
        ...
        <!-- CTA Section -->
        <section class="cta-section" style="background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('assets/img/backgrounds/cta-bg.jpg') center/cover no-repeat; padding: 100px 0; text-align: center;">
    <div class="container" data-aos="fade-up" style="color: white;">
        <h2 style="font-size: 36px; margin-bottom: 20px; color: white;">Can't Find Your Dream Venue?</h2>
        <p style="font-size: 18px; max-width: 700px; margin: 0 auto 30px; color: white;">Our wedding specialists can help you discover the perfect location for your celebration</p>
        <a href="contact.html" class="view-btn" style="background: var(--secondary-color); border-color: var(--secondary-color);">Contact Our Planners</a>
    </div>
</section>
