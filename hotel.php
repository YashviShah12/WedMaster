...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>Premium Wedding Venues | Fernweh Weddings</title>
        <meta name="description" content="Discover our exquisite wedding venues for your perfect day">
    ...
    .header-sticky.sticky-bar {
        ...
        .card:before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(to bottom, rgba(156, 124, 86, 0.1), rgba(156, 124, 86, 0.3));
            opacity: 0;
            transition: var(--transition);
            z-index: 1;
        }
        ...
        .testimonials-section {
            padding: 100px 0;
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('assets/img/backgrounds/testimonial-bg.jpg') center/cover no-repeat;
            color: var(--white);
            position: relative;
        }
       ...
       .cta-section {
    padding: 100px 0;
    background: linear-gradient(rgba(142, 118, 96, 0.85), rgba(180, 155, 127, 0.85)), url('assets/img/backgrounds/cta-bg.jpg') center/cover no-repeat;
    color: #fefcf9; /* soft off-white */
    text-align: center;
    position: relative;
    overflow: hidden;
}
        ...
        .cta-section:before {
            ...
            width: 100%;
            height: 100%;
            background: url('assets/img/patterns/pattern-dots.png') repeat;
            opacity: 0.1;
        }
   ...
   <body>
    ...
    <main>
        ...
        <div class="slider-area2">
            <div class="single-slider slider-height2 hero-overly d-flex align-items-center" style="background-image: url('assets/img/hero/wedding-venues-hero.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap text-center">
                                <h2 data-aos="fade-up" data-aos-delay="200">Wedding Venues</h2>
                                <p data-aos="fade-up" data-aos-delay="400" style="color:#ffffff">Discover the perfect setting for your special day</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="venues-section">
            <div class="container">
                <div class="section-title" data-aos="fade-up">
                    <h2>Premium Wedding Venues</h2>
                    <p>Exquisite locations that will make your wedding day truly magical</p>
                </div>
        ...
        <section class="cta-section">
            <div class="container">
                <div class="cta-content" data-aos="fade-up">
                    <h2 style="font-size: 36px; margin-bottom: 20px;">Ready to Find Your Perfect Venue?</h2>
                    <p style="font-size: 18px; max-width: 700px; margin: 0 auto;">Our wedding specialists can help you discover the ideal location for your special day</p>
                    <a href="contact.html" class="cta-btn">Schedule a Visit</a>
                </div>
            </div>
        </section>
                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>Newsletter</h4>
                                <p style="font-weight: 500; color: #ffffff;">Subscribe for wedding tips and special offers</p>
